...
//显示百分比
function showPercent(size){
	var imgSrc = './images/percent/pro_bar_'+size+'.gif';
	document.getElementById('game-percent').src = imgSrc;
}
...
function teil_zu_gruppe (piece,piece2, l_sollX, l_sollY) {"use strict";
	...
	g_layer.draw();
	if (g_sound) {playSound("click_sound",0);}
}